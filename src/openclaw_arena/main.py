...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional CSV snapshot file path (columns: step,price,momentum,volatility)",
    )
...
def main() -> None:
    args = parse_args()
    result = run_simulation(steps=args.steps, seed=args.seed, snapshot_path=args.snapshot_path)
